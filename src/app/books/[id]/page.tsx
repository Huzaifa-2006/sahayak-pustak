      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-auto space-y-3">
            <a
              href={`mailto:${(book.seller as any).email}?subject=Interested in: ${book.title}&body=Hi, I saw your listing on Sahayak Pustak and I'm interested in "${book.title}". Is it still available?`}
